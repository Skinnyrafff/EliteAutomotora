...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<['published', 'reserved', 'sold']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vehicle.vehicle'
    ...
    mileageKm: Schema.Attribute.Integer;
    ownersCount: Schema.Attribute.Integer &
    ...
    primaryPhoto: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    transmission: Schema.Attribute.Enumeration<['AT', 'MT', 'CVT', 'DCT']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
