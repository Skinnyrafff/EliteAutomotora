...
export interface ApiVehicleVehicle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estado: Attribute.Enumeration<['published', 'reserved', 'sold']>;
    location: Attribute.String;
    mileageKm: Attribute.Integer;
    ...
    primaryPhoto: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Attribute.DateTime;
    seller: Attribute.Relation<
      ...
      'api::seller.seller'
    >;
    slug: Attribute.UID<'api::vehicle.vehicle', 'title'>;
    title: Attribute.String & Attribute.Required;
    transmission: Attribute.Enumeration<['AT', 'MT', 'CVT', 'DCT']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::vehicle.vehicle',
      'oneToOne',
